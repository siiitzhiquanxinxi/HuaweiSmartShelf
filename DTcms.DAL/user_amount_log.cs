...
namespace DTcms.DAL
{
    ...
    public partial class user_amount_log
    {
        ...
        {
            string strSql = "select id from " + databaseprefix + "user_amount_log order by id desc limit 1";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,user_id,user_name,value,remark,add_time from " + databaseprefix + "user_amount_log ");
