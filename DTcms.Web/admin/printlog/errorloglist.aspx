<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="errorloglist.aspx.cs" Inherits="DTcms.Web.admin.printlog.errorloglist" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <%#Convert.ToDateTime(Eval("ErrTime")).ToString("yyyy-MM-dd HH:mm:ss")%>
                        </td>
                        <td>
                            <%#Eval("MachineID")%>
                        </td>
                        <td align="center"><a href="errorlogdetail.aspx?id='<%#Eval("Id") %>'">详细</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
