<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printlog_yinyezhizhao.aspx.cs" Inherits="DTcms.Web.admin.printlog.printlog_yinyezhizhao" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        ...
                        <div class="menu-list">
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddlZhengFu" runat="server">
                                    <asp:ListItem Value="-1">全部</asp:ListItem>
                                    <asp:ListItem Value="0">正副本皆成功</asp:ListItem>
                                    <asp:ListItem Value="1">仅正本成功</asp:ListItem>
                                    <asp:ListItem Value="2">仅副本成功</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div>
        ...
        <div class="page-footer">
            <div class="btn-wrap">
                <asp:Button ID="btnExport" runat="server" Text="导出Excel" CssClass="btn" OnClick="btnExport_Click" />
            </div>
        </div>
        <!--/工具栏-->
